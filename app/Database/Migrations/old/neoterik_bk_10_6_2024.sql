...
REPLACE INTO `dskpn` (`dskpn_id`, `dskpn_code`, `dskpn_theme`, `dskpn_sub_theme`, `tm_id`, `op_id`, `aa_id`, `created_at`, `updated_at`, `deleted_at`, `approved_at`, `created_by`, `approved_by`, `dskpn_status`, `dskpn_remarks`) VALUES
