<style>
    ...
    .custom-radio input[type="radio"] {
        ...
        width: 0;
        height: 0;
        opacity: 0; /* Hide original radio button */
    }

    .custom-control-label {
        padding-left: 35px; /* Space for the custom style */
        position: relative;
    }
    ...
    .custom-control-label::before {
        ...
        border: 2px solid #613673; /* Border color */
        border-radius: 4px; /* Slight rounding to create squared effect */
        transform: translateY(-50%); /* Centering the square */
        transition: background 0.3s, border 0.3s;
    }

    .custom-control-input:checked + .custom-control-label::before {
        background: #613673; /* Background color when checked */
        border-color: #613673; /* Change border color when checked */
    }
    ...
    .active-outline {
        outline: 3px solid #4CAF50; /* Green outline when activated */
        outline-offset: 4px;
        box-shadow: 0 0 6px rgba(76, 175, 80, 0.4); /* Softer, lighter green glow */
        transition: outline 0.4s, box-shadow 0.4s ease-in-out;
    }

    .inactive-outline {
        outline: 3px solid #f44336; /* Red outline when deactivated */
        outline-offset: 4px;
        box-shadow: 0 0 6px rgba(244, 67, 54, 0.4); /* Softer, lighter red glow */
        transition: outline 0.4s, box-shadow 0.4s ease-in-out;
    }
    .custom-close-btn {
        background: none;
    ...
    .custom-close-btn:hover {
        color: #f8a5c2; /* Soft pink color on hover */
