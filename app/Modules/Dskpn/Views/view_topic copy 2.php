                                ...
                                foreach ($topics as $topic) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-sm btn-warning action-icon" onclick="openEditTopicModal(<?= $topic['tm_id'] ?>, <?= $topic['tm_year'] ?>, <?= $topic['ctm_id'] ?>, '<?= rawurlencode($topic['tm_desc']) ?>')">
