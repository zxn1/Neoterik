...
class DskpnModel extends Model
{
    ...
    protected $allowedFields = ['dskpn_code', 'dskpn_theme', 'dskpn_sub_theme', 'tm_id', 'op_id', 'aa_id', 'approved_at', 'created_by', 'approved_by']; // Fields that are allowed to be inserted/updated
