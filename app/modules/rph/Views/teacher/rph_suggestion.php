        ...
        <div class="card-body p-3 mt-2" style="height: auto;">
          <div class="tab-content" id="v-pills-tabContent">
            ...
            <div class="tab-pane fade position-relative border-radius-lg active show" id="objektif_prestasi" role="tabpanel" aria-labelledby="objektif_prestasi">
              <div class="d-flex top-0 w-100">
                <ul class="list-group flex-grow-1 mx-2" style="flex-basis: 0; flex-grow: 1;">
                  <li class="list-group-item">1.1.2 Memerihalkan proses pertukaran gas yang berlaku di paru-paru (S 2.1.2)</li>
                  <li class="list-group-item">1.1.3 Membezakan kandungan gas semasa menarik dan menghembus nafas melalui lukisan (S 2.1.3, SV1.1.1)</li>
                  <li class="list-group-item">1.1.4 Memerihalkan pergerakan dada semasa menarik dan menghembus nafas melalui pemerhatian (S 2.1.2, S 2.1.4, S 2.1.6)</li>
                  <li class="list-group-item">1.1.5 Merumuskan kadar pernafasan bergantung kepada jenis aktiviti yang dilakukan (S 2.1.5)</li>
                  <li class="list-group-item">1.1.6 Mengenali contoh penyakit tidak berjangkit berkaitan sistem pernafasan manusia (PK 6.1.1)</li>
                  <li class="list-group-item">1.1.7 Menghubungkait punca dan kesan penyakit tidak berjangkit terhadap pernafasan manusia (PK 6.1.2)</li>
                  <li class="list-group-item">1.1.8 Berkomunikasi mengenai cara pencegahan penyakit (PK 6.1.3)</li>
